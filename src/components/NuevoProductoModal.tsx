...
interface NuevoProductoModalProps {
  open: boolean;
  onClose: () => void;
  onSave: (producto: ProductoData) => void;
}
...
export function NuevoProductoModal({ open, onClose, onSave }: NuevoProductoModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={handleCancel}>
      <DialogContent className="max-w-2xl bg-card backdrop-blur-lg border-primary/30">
        <DialogHeader>
          <DialogTitle className="text-2xl text-primary">Agregar Nuevo Producto</DialogTitle>
          <DialogDescription>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="precioRegular">
                Precio Regular (COP) <span className="text-destructive">*</span>
              </Label>
              <div className="relative">
            ...
            {/* Precio Servicio */}
            <div className="space-y-2">
              <Label htmlFor="precioServicio">Precio Servicio (COP)</Label>
              <div className="relative">
                <span className="absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground">
                  $
                </span>
