...
import { Star, MessageSquare, User, Mail, Send, CheckCircle } from 'lucide-react';
                    ...
                    <button
                      ...
                      onClick={() => {
                        try {
                          ...
                          if (process.env.NODE_ENV === 'development') console.error('❌ Error al seleccionar calificación:', error);
                        }
                      }}
