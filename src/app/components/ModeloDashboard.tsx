              ...
              <div className="flex gap-2">
                ...
                {puedeIniciarServicio && !servicioActivo && (
                  <Button
                    ...
                    size="sm"
                    className="bg-gradient-to-r from-[#b8860b] via-[#d4af37] to-[#ffd700] hover:brightness-110 text-black font-black shadow-lg shadow-[#d4af37]/25 gap-2 border-0 px-4 h-9 transition-all"
                  >
                    <Play className="w-4 h-4 fill-black" /> Iniciar Servicio
                  </Button>
                )}
              </div>
            </div>
